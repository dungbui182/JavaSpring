...
@NamedQueries({
    ...
    @NamedQuery(name = "User.findByVaitroHD", query = "SELECT u FROM User u WHERE u.vaitroHD = :vaitroHD")})
...
//    @NotNull
    ...
    @Size(max = 45)
    @Column(name = "vaitroHD")
    private String vaitroHD;
    @OneToMany(mappedBy = "idGV")
    private Set<Diemkhoaluan> diemkhoaluanSet;
    @JoinColumn(name = "idHD", referencedColumnName = "id")
    @ManyToOne
    private Hoidong idHD;
    ...
    public String getVaitroHD() {
        return vaitroHD;
    }

    public void setVaitroHD(String vaitroHD) {
        this.vaitroHD = vaitroHD;
    }

    @XmlTransient
    public Set<Diemkhoaluan> getDiemkhoaluanSet() {
        return diemkhoaluanSet;
    }

    public void setDiemkhoaluanSet(Set<Diemkhoaluan> diemkhoaluanSet) {
        this.diemkhoaluanSet = diemkhoaluanSet;
    }

    public Hoidong getIdHD() {
        return idHD;
    }

    public void setIdHD(Hoidong idHD) {
        this.idHD = idHD;
    }
